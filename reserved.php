		...
		<div class="panel panel-default">
			<div class="panel-body">
			 <h2>
				...
				<div class="container-fluid">
					<form class="form-horizontal" role="form" id="form-journey">
					  ...
					  <button type="submit" class="btn btn-success">Find Train
...
<script type="text/javascript">
	$(document).on('submit', '#form-journey', function(event) {
