			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<strong>
                        ...
                        <?php require_once('data/get_train.php');?>
                        <strong>Train Name:</strong> <?= $train['trn_name'];  ?><br />
                        <strong>Train Number:</strong> <?= $train['trn_num'];  ?><br />
                        
                       
			 			<?php require_once('data/depart_from_to.php');?> 
                         <strong>From:</strong> <?= $origin['origin_desc'];  ?><br />     
			 			 <strong>To:</strong> <?= $dest['dest_destination'];  ?><br />
			 			 </h3>
